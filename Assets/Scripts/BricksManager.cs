...
public class BricksManager : MonoBehaviour
{
    ...
    private float initialBrickSpawnPosityonX = -1.96f;
    private float initialBrickSpawnPosityonY = 3.325f;
    ...
    internal void LoadNextLevel()
    {
        ...
        {
            GameManger.Instance.ShowVictoryScreen();
        }
        else
        {
    ...
    private void GenerateBricks()
    {
        ...
        float currentSpawnX = initialBrickSpawnPosityonX;
        float currentSpawnY = initialBrickSpawnPosityonY;
        float zShift = 0;
        ...
        for (int row = 0; row < this.maxRows; row++)
        {
            for (int col = 0; col < this.maxCols; col++)
            {
                ...
                {
                    currentSpawnX = initialBrickSpawnPosityonX;
                }
            }
